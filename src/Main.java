...
//        inMemoryTaskManager.addNewTask(task0); // time intersection: false
//
//
...
//        inMemoryTaskManager.addNewTask(task1);// time intersection: false
//
//
...
//        inMemoryTaskManager.addNewTask(task2); // without starting time
//
//
...
//        inMemoryTaskManager.addNewTask(task3); // time intersection: true


        Epic epic0 = new Epic("Moving on", "Changing residence"); // create Epic
        inMemoryTaskManager.addNewEpic(epic0);
        ...
        inMemoryTaskManager.addNewSubtaskForEpic(subtask0); // time intersection: false
        ...
        inMemoryTaskManager.addNewSubtaskForEpic(subtask1); // time intersection: true
        ...
        inMemoryTaskManager.addNewSubtaskForEpic(subtask2);// time intersection: false

//        inMemoryTaskManager.getTaskList().forEach(System.out::println);
        inMemoryTaskManager.getEpicList().forEach(System.out::println);
        inMemoryTaskManager.getSubtaskList().forEach(System.out::println);
        ...
        System.out.println("remove third subtask");
